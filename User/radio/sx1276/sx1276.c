...
void SX1276Init( RadioEvents_t *events ) //  Radio.Init( &RadioEvents );
{
    uint8_t i;
    ...
    Radio.Write( REG_LR_SYNCWORD, 0x22 );  // add by hellogz 2016/05/12
    ...
    case MODEM_LORA:
        {
            ...
            {
                SX1276.Settings.LoRa.LowDatarateOptimize = TRUE;
            }
            else
            {
...
void SX1276Send( uint8_t *buffer, uint8_t size ) // Radio.Send();
{
...
void SX1276SetRx( uint32_t timeout ) // Radio.Rx( Rx_timeout );
{
    ...
    case MODEM_LORA:
        {
            ...
            if( SX1276.Settings.LoRa.Bandwidth < 9 )
            {
                ...
                case 0: // 7.8 kHz
                    ...
                    SX1276SetChannel((uint32_t)(SX1276.Settings.Channel + 7.81e3) );
                    break;
                case 1: // 10.4 kHz
                    SX1276Write( REG_LR_TEST2F, 0x44 );
                    SX1276SetChannel((uint32_t)(SX1276.Settings.Channel + 10.42e3) );
                    break;
                case 2: // 15.6 kHz
                    SX1276Write( REG_LR_TEST2F, 0x44 );
                    SX1276SetChannel((uint32_t)(SX1276.Settings.Channel + 15.62e3) );
                    break;
                case 3: // 20.8 kHz
                    SX1276Write( REG_LR_TEST2F, 0x44 );
                    SX1276SetChannel((uint32_t)(SX1276.Settings.Channel + 20.83e3) );
                    break;
                case 4: // 31.2 kHz
                    SX1276Write( REG_LR_TEST2F, 0x44 );
                    SX1276SetChannel((uint32_t)(SX1276.Settings.Channel + 31.25e3) );
                    break;
                case 5: // 41.4 kHz
                    SX1276Write( REG_LR_TEST2F, 0x44 );
                    SX1276SetChannel((uint32_t)(SX1276.Settings.Channel + 41.67e3) );
                    break;
                case 6: // 62.5 kHz
...
{
    // Set RESET pin to 0
    GpioInit( &SX1276.Reset, RADIO_RESET, PIN_OUTPUT, PIN_PUSH_PULL, PIN_PULL_DOWN, 0 );

    // Wait 1 ms
    DelayMs( 1 );

    // Configure RESET as input
    GpioInit( &SX1276.Reset, RADIO_RESET, PIN_INPUT_NO_IT, PIN_PUSH_PULL, PIN_HI_Z, 1 );
